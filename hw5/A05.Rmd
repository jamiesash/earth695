...
## Solution to Ex 2. {-} 
The conjugate prior for a Poisson Process is the gamma distribution. The kernal for the gamma distribution is expressed as...
$$
[y|\alpha,\beta] = y^{\alpha-1}e^{-\beta y} 
$$
With the posterior gamma's $\alpha$ and $\beta$ equal to $\alpha+\sum{y_i}$ and $\beta+n$ respectively. The uninformative prior for the gamma distribution is a gamma with shape and rate ($\alpha$ and $\beta$) equal to 0.001, $gamma(0.001, 0.001)$. 
...
## Solution to Ex 3 {-}  
(Put your solution here. No numerical work or plots are required.)  
...
## Solution to Ex 4. {-}  
(Put your answers here. No numerical work or plots are required.)  
...
(Put your chunk, plots and narrative here. I wrote a couple of lines for you in this first chunk.)  
